...
class FeatureExtraction:
    ...
    def Hppts(self):
        try:
            ...
            if 'https' in https:
                # Check other suspicious factors for HTTPS URLs
                suspicious_count = 0
                if self.SubDomains() == -1:
                    suspicious_count += 1
                if self.prefixSuffix() == -1:
                    suspicious_count += 1
                if self.Favicon() == -1:
                    suspicious_count += 1
                if self.RequestURL() == -1:
                    suspicious_count += 1
                
                # If multiple suspicious factors, reduce the HTTPS benefit
                if suspicious_count >= 2:
                    return 0  # Neutral
                return 1  # Still consider HTTPS as positive
            return -1
        except:
            return 0
