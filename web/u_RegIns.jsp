...
<%
					...
					try {
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from user  where name='"+uname+"' or  email='"+email+"' or  mobile='"+mno+"' " ; 
					...
					if ( rs1.next() )
					   {
								...
								out.println("User Name and email or phone number Already Exits");							
							%>
							<p><a href="u_register.html">Back</a>         <a href="index.html">Home</a> </p>
							<%
					   }
					   else
					   {
