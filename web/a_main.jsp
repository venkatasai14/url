      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li class="style8">
              <div align="left"><a href="url.jsp">Check Phising Url's</a></div>
            </li>
<!--              <li class="style8">
              <div align="left"><a href="checkurl.jsp">Check Phising Url's1</a></div>
            </li>-->
              </li>
              <li class="style8">
              <div align="left"><a href="checkurlp.jsp">Check Phising Url's2</a></div>
            </li>
              <li class="style8">
              <div align="left"><a href="admin_url_analyzer.jsp">Admin Url Analyzer</a></div>
            </li>
            <li>
