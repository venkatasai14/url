...
@WebServlet("/a_add_topic")
@MultipartConfig(maxFileSize = 16177215)  
public class a_add_topic extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
	    ...
	    ResultSet rs1=st1.executeQuery(query1);
            ...
            if (inputStream != null) {
             ...
             if(i == 1)
             {
                 response.sendRedirect("a_add_topic.jsp?success");
             }
            ...
            {
               response.sendRedirect("a_add_topic.jsp?failed");
            }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            try {
                ...
                Logger.getLogger(a_add_topic.class.getName()).log(Level.SEVERE, null, ex);
